This repository is a template for the climate change module. 

## Assignment

- `assignment/climate-change.qmd`

## Data

- Data are downloaded from NASA and NOAA servers
...
- Files in the `img` directly are used in the presentation.
